...
int main (int argc, char **argv)
{
	...
	CameraImageBackground::Ptr cameraImage (new CameraImageBackground (rosnode, "/camera/image_raw", WINDOW_WIDTH, WINDOW_HEIGHT));
	//cameraImage->disable();

	// Drawing order depend on this list
	app.addObject (cameraImage);
	app.setCameraBackground (cameraImage);
