...
public:
	VectorMapObject(RenderWidget *w);
...
public:
	TRectangle (const Point3 &p1, const Point3 &p2, const Point3 &p3, const Point3 &p4, RenderWidget *w);
	void initialize ();
	void draw ();
...
{
public:
	MapPoints (VectorMap *mapsrc, RenderWidget *w);
	~MapPoints ();
	void draw ();
	bool filterDistance;
