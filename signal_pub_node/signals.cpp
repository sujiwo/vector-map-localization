...
#include "Math.h"
#include <Eigen/Eigen>
#include "signal_pub_node/Signals.h"
...
int main (int argc, char *argv[])
{
	...
	ros::Publisher signalPublisher = rosnode.advertise <signal_pub_node::Signals> ("SignalProjector", 100);
